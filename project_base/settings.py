...
MY_APPS= ['normalizers', 'transactions']
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'CNAB Normalizer',
    'DESCRIPTION': 'This simply API project, developed to normalize TXT file "CNAB" to database',
    'VERSION': "1.0.0",
